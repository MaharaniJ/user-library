...
function Users() {
    ...
    let loaddata = async () => {
        setLoading(true)
        let users = await axios.get(`https://645cd360e01ac61058945382.mockapi.io/users`)
        setUsers(users.data)
        setLoading(false)
    }
    let userDelete = async (id)=>{
        try{
            ...
            if(ask){
                await axios.delete(`https://645cd360e01ac61058945382.mockapi.io/users/${id}`)
                loaddata()
            }
    ...
    return (
        <div className="container-fluid">
            <div className='d-sm-flex align-items-center justify-content-between mb-4'>
                ...
                <p className="mb-4">
                    <Link to="/portal/createuser" className={"d-none d-sm-inline-block btn-sm btn-primary"}><li className='fas fa-download fa-sn text-white-50'>
                        </li>Create user</Link></p>
            </div>
            {/* <!-- DataTales Example --> */}
            {
